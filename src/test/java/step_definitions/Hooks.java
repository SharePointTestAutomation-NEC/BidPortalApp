        ...
        switch (browser.toLowerCase()) {
            ...
            case "chrome":
               ...
               // WebDriverManager.chromedriver().setup();
                //System.out.println("WebDriverManager.chromedriver().setup();"+ WebDriverManager.chromedriver().setup());
                ...
                if (os.contains("win")) {
                   ...
                   // chromeOptions.setExperimentalOption("useAutomationExtension", false);
                    ...
                    System.out.println("if win********************************************chrome");

                  //  driver.manage().window().maximize();
                    System.out.println("if********************************************chrome");
                    ...
                    chromeOptions.addArguments("disable-infobars");
                   // chromeOptions.setExperimentalOption("useAutomationExtension", false);
                    System.out.println("Else********************************************chrome");
                    driver = new ChromeDriver(chromeOptions);
                    System.out.println("Else********************************************chrome");
            ...
            case "chromeheadless":
                System.setProperty("webdriver.chrome.driver", driverDirectory + "/chrome/chromedriver.exe");
                System.out.println("chromeheadless********************************************chrome");
            ...
            case "chromeheadlesswindows":
                System.out.println("chromeheadlesswindows********************************************chrome");
                System.setProperty("webdriver.chrome.driver", driverDirectory + "/chrome/chromedriver.exe");
                chromeOptions.addArguments("headless");
                chromeOptions.addArguments("window-size=1200x600");
                driver = new ChromeDriver(chromeOptions);
