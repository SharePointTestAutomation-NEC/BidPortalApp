...
public class Generic_Steps extends BaseClass {
	...
	@Then("^Verify the respective record not get deleted$")
	public void verifyTheRespectiveRecordNotGotDeleted() throws InterruptedException {
		bidPage.confirmNotDeletMessage();
	}
